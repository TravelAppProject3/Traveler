      ...
      <div>
        ...
        <div className="container">
          <div style={this.styles.border}>
            ...
            <div className="row">
              ...
              <ul style={this.styles.ul} className="col-md-4">
                <li style={this.styles.liTitle}>
                  <span style={this.styles.span} className="fa fa-ticket" />Events
                </li>
                <li style={this.styles.li}>Central Park</li>
                <ul style={this.styles.ulNest}>
                  <li style={this.styles.liNest}>
                    <span
              ...
              <ul style={this.styles.ul} className="col-md-4">
                <li style={this.styles.liTitle}>
                  <span style={this.styles.span} className="fa fa-bed" />Hotels
                </li>
              ...
              <ul style={this.styles.ul} className="col-md-4">
                <li style={this.styles.liTitle}>
                  <span style={this.styles.span} className="fa fa-cutlery" />Restaurants
                </li>
          ...
          <div style={this.styles.border}>
            ...
            <img
              style={this.styles.img}
              src="https://www.paulreiffer.com/wp-content/uploads/2012/01/Paul_Reiffer_Photographer_San_Francisco_Bay_Bridge_Cityscape_Treasure_Island_Sunset_Night_Time.jpg"
            />
            <div className="row">
              {/* <div style={this.styles.col} className="col-md-4"> */}
              <ul style={this.styles.ul} className="col-md-4">
